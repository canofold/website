...
description: Choose build, deployment, monitoring, or upgrade capabilities
group: Guide
...
- [Production monitoring](/en/guide/delivery/monitoring/): integrate the Sentry Browser Loader.
